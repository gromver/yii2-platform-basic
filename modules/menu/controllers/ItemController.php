...
namespace gromver\platform\basic\backend\modules\menu\controllers;

use kartik\widgets\Alert;
use gromver\modulequery\ModuleQuery;
use Yii;
use gromver\platform\basic\menu\models\MenuItem;
use gromver\platform\basic\menu\models\MenuItemSearch;
...
class ItemController extends Controller
{
    ...
    public function actionRouters()
    {
        ...
        $items = ModuleQuery::instance()->implement('\gromver\platform\basic\interfaces\MenuRouterInterface')->orderBy('desktopOrder')->fetch('getMenuRoutes');
