...
/* @var $searchModel gromver\platform\basic\menu\models\MenuItemSearch */
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filter' => \yii\helpers\ArrayHelper::map(\gromver\platform\basic\menu\models\MenuType::find()->all(), 'id', 'title')
            ],
            /*[
                'attribute' => 'parent_id',
                'width' => '100px',
                ...
                'filter' => \yii\helpers\ArrayHelper::map(\gromver\platform\basic\menu\models\MenuItem::find()->noRoots()->orderBy('lft')->all(), 'id', function($model){
                    /** @var $model \gromver\platform\basic\menu\models\MenuItem * /
            ...
            [
                ...
                'filter' => \gromver\platform\basic\menu\models\MenuItem::statusLabels(),
                'width' => '90px',
                'format' => 'raw'
            ],
            [
