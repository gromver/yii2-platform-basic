...
/* @var $model gromver\platform\basic\menu\models\MenuItem */
/* @var $sourceModel gromver\platform\basic\menu\models\MenuItem */
/* @var $linkParamsModel gromver\platform\basic\menu\models\MenuLinkParams */
...
<div class="menu-form">
    ...
    <div class="tab-content">
        <div id="main" class="tab-pane active">
            <?= $form->field($model, 'menu_type_id')->dropDownList(['' => Yii::t('gromver.platform', 'Select ...')] + \yii\helpers\ArrayHelper::map(\gromver\platform\basic\menu\models\MenuType::find()->all(),'id', 'title'), ['id' => 'menu_type_id']) ?>
            ...
            <?php $this->registerJs("$('#" . Html::getInputId($model, 'link_type') . "').change(function (event){
                if($(this).val() === '" . \gromver\platform\basic\menu\models\MenuItem::LINK_ROUTE . "') {
