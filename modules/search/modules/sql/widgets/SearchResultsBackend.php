...
namespace gromver\platform\basic\modules\search\modules\sql\widgets;


use gromver\modulequery\ModuleEvent;
use gromver\platform\basic\modules\search\modules\sql\models\Index;
use gromver\platform\basic\modules\search\modules\sql\widgets\events\SqlBeforeSearchEvent;
 ...
 */
class SearchResultsBackend extends \gromver\platform\basic\modules\search\widgets\SearchResultsBackend
{
    ...
    protected function launch()
    {
        ...
        foreach ($this->models as $modelClass) {
            ModuleEvent::trigger(self::EVENT_BEFORE_SEARCH . $modelClass, new SqlBeforeSearchEvent([
                'query' => $query,
                'sender' => $this
            ]));
        }
