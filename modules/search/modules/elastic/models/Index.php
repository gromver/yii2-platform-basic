...
namespace gromver\platform\basic\modules\search\modules\elastic\models;
...
class Index extends \yii\elasticsearch\ActiveRecord implements ViewableInterface
{
    ...
    {
        return Yii::$app->getModule(ModuleQuery::instance()->implement('\gromver\platform\basic\modules\search\modules\elastic\Module')->find()[0])->elasticsearchIndex;
    }
