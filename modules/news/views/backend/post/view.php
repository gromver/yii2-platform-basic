...
<div class="post-view">
    ...
    <p>
        <?= Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('gromver.platform', 'Add'), ['create', 'category_id' => $model->category_id, 'language' => $model->language], ['class' => 'btn btn-success']) ?>
